...
export const projectsData: Project[] = [
  {
    ...
    year: "2026",
    category: "Conceptual Presence for a High-End Napa Valley Winery",
    challenge:
      "Translating the tactile, luxurious experience of a premium California wine into a digital medium. The digital presence needed to instantly convey a sense of rich heritage, exclusivity, and quality.",
    approach:
  ...
  },
  {
    ...
    tags: ["Digital & Visual", "Concept Design"],
    year: "2026",
    category: "Digital Portfolio for an Editorial Wedding Photographer",
    challenge:
      "Displaying highly emotional, narrative-driven photography requires a delicate balance. The challenge was to create a digital space that felt high-end, timeless, and strictly editorial, without the interface ever overpowering or competing with the imagery itself.",
    approach:
  ...
  },
  {
    ...
    tags: ["Digital & Visual", "Concept Design"],
    year: "2025",
    category: "Storefront for a Sustainable Coffee Brand",
    challenge:
      "The objective was to design a platform that effectively communicated the brand's core commitment to sustainability, while simultaneously delivering a seamless, conversion-optimized shopping experience.",
    approach:
  ...
  },
  {
    ...
    tags: ["Digital & Visual", "Concept Design"],
    year: "2025",
    category: "Promotional Showcase for a Luxury Fragrance",
    challenge:
  ...
  },
  {
    ...
    tags: ["Digital & Visual", "Concept Design"],
    year: "2026",
    category: "Digital Journal Dedicated to Coastal Film Photography",
    challenge:
